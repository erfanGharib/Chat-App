...
const ChatItem = props => {
    ...
    return (
        <div className='chat-item w-full p-2 rounded-c flex hover:bg-neutral-700 hover:bg-opacity-50 cursor-pointer'>
            <Avatar size='14' />
            <div id='info' style={{width:'calc(100% - 70px)'}}>
                ...
                <div id='subtitle' className='w-full f-center-between'>
                    <p className='last-message text-ellipsis overflow-hidden whitespace-nowrap h-6 '>
                        {IS_GROUP_CHAT ? <span className='sender-name font-medium text-neutral-200'>erfan: </span> : ''}
