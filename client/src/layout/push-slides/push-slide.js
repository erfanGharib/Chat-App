...
const PushSlide = props => {
    ...
    return (
        <div id='push-slide' className={`p-3 bg-neutral-800 z-10 min-w-320 w-80 h-full transition-transform duration-300 ${DISPLAY_STATUS ? '-translate-x-1/2' : 'translate-x-1/2'} transform`}>
